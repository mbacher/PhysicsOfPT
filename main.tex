...
versa. \revpurpdel{This secondary magnetic field \(\mathbf{H}_{\mathbf{e}}\) originating from the eddy-current region \(\Gamma_{\sigma 1 > 0}\) can be expressed by
...
\nabla \times \mathbf{H}_{e}
= \mathbf{J}_{\text{src}} + (\sigma + j\omega \epsilon) \mathbf{E}_{tissue} = \mathbf{J}_{src} + \gamma \mathbf{E}_{tissue} = \mathbf{J}_{src} + \mathbf{J}_{tissue}
...
procedure outlined in \cite{Harms2021Theory} the generating coil is modeled as having a
