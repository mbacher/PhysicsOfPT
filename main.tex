...
Table~\ref{tab:exp-sparams} summarises the measured scattering parameters and cardiac modulation depths for all three volunteers (per-channel data in Appendix Tables~\ref{tab:exp-v1}--\ref{tab:exp-v3}). The PT signal was detected in all active receive channels, with $S_{1,n}$ values ranging from $-79$ to $-120$\,dB across all subjects and channels.
