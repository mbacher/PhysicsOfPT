...
\begin{table}[htbp]
\centering
\caption{\revbrown{Strongest-channel cardiac modulation depths per volunteer: the maximum and the mean of the five most strongly modulated channels (pooled across anterior and posterior elements). These summarise the signal available to source-separation post-processing, which typically retains only the most strongly modulated channels. Magnitude values to be completed from the processing pipeline.}}
\label{tab:exp-topN}
\begin{tabular}{lcccc}
\hline
 & \multicolumn{2}{c}{Mag.\ mod.\ depth (\%)} & \multicolumn{2}{c}{Phase mod.\ depth (mrad)} \\
...
\hline
V1 & \textcolor{red}{[TBD]} & \textcolor{red}{[TBD]} & 141.9 & 120.8 \\
V2 & \textcolor{red}{[TBD]} & \textcolor{red}{[TBD]} & 539.2 & 308.9 \\
V3 & \textcolor{red}{[TBD]} & \textcolor{red}{[TBD]} & 604.3 & 279.5 \\
\hline
Pooled & \textcolor{red}{[TBD]} & \textcolor{red}{[TBD]} & 604.3 & 415.3 \\
\hline
\end{tabular}
\end{table}
% \begin{figure}[htbp]
...
heart as possible  - the heart should ideally lie on the axis perpendicular to the loops center, though some centimeters of tolerance are acceptable \cite{Bacher2017CardiacStudy}\rev{; experimental testing indicates that a lateral offset of around 5\,cm remains permissible in real-world use cases}.
