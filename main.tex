...
Figure~\ref{fig:mod-depth-bars-mag} for magnitude and in Figure~\ref{fig:mod-depth-bars-phase} for phase\revred{, with per-channel correlation coefficients listed in Table~\ref{tab:per-channel}}.
...
Modulation depths (see also Figures~\ref{fig:mod-depth-bars-mag} and~\ref{fig:mod-depth-bars-phase} and Table~\ref{tab:per-channel}) were found to be
...
(individual elements in Figures~\ref{fig:mod-depth-bars-mag} and~\ref{fig:mod-depth-bars-phase} and Table~\ref{tab:per-channel}) also
...
% Figure moved to Appendix (old figures) — data now in Tables~\ref{tab:correlation} and~\ref{tab:per-channel}
...
\begin{figure}[htbp]
\centering
\revbrown{\includegraphics[width=\columnwidth]{./media/vol_segmentation.svg}
...
\begin{figure}[htbp]
\centering
\revbrown{\includegraphics[width=\columnwidth]{./media/vol_anterior_mag.svg}
\caption{Per-channel averaged cardiac magnitude S-parameter waveforms for all anterior elements (Volunteer~3, 24 cycles averaged). Blue: mean waveform; red band: $\pm 1.96\,\sigma$ noise level (95\,\% confidence interval). Modulation depth is visible as the peak-to-peak excursion of the blue trace.}
\label{fig:exp-anterior-mag}}
\end{figure}

\begin{figure}[htbp]
\centering
\revbrown{\includegraphics[width=\columnwidth]{./media/vol_posterior_mag.svg}
