...
\newcommand{\revpurpdel}[1]{\textcolor{violet}{\sout{#1}}}
...
\revorange{It is important to note that the near-field condition is not merely a simplification adopted in this work but a consequence of the system design and bore geometry. In the original PT implementation, the carrier frequency was constrained to lie just outside the MR imaging band so that the signal could be received by the existing MR receive chain --- at 1.5T and 3T this places the PT frequency at 62.5\,MHz and 122.5\,MHz respectively, well within the near-field regime.}
...
\revgreen{Results are presented at 62.5\,MHz and 122.5\,MHz, corresponding to Larmor frequencies at 1.5\,T and 3\,T, respectively.}
