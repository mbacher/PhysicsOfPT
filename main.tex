...
Beyond reaching the body surface, the field must penetrate the tissue to the depth of the heart (typically 5--15\,cm below the anterior chest wall). In a lossy medium the field amplitude decays over the penetration depth $\delta = 1/\alpha$, with $\alpha = \omega\sqrt{\mu_0\varepsilon/2}\,\big(\sqrt{1+(\sigma/\omega\varepsilon)^2}-1\big)^{1/2}$. Using representative tissue properties, this gives, for muscle, $\delta \approx 9$\,cm at 62.5\,MHz and $\approx 7$\,cm at 122.5\,MHz, and for blood $\approx 6.5$\,cm and $\approx 5$\,cm, respectively. Low-conductivity adipose tissue is penetrated substantially more deeply. These depths are comparable to the anterior heart depth, so the interrogating field reaches the myocardium (although attenuated) consistent with the stronger coupling observed for anteriorly placed elements and with the field acting as a weak perturbation rather than a fully penetrating illumination.
