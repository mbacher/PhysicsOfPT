...
% PT source block
\node[draw=blue!70!black, thick, fill=blue!12, rounded corners=2pt, minimum width=1.0cm, minimum height=1.3cm, inner sep=2pt, align=center, font=\scriptsize] (pt) at (-6.3,-0.1) {\textcolor{blue!70!black}{PT}\\\textcolor{blue!70!black}{(1)}};
\draw[->, thick, blue!60] (-7.2,-0.1) -- (pt.west) node[midway, above, font=\scriptsize] {$I_1$};
\draw[->, blue!45, thick] (pt.east) to[bend left=8] (-3.5,0.5);
\draw[->, blue!45, thick] (pt.east) to[bend right=8] (-3.5,-0.7);
% RX coil block
\node[draw=red!70!black, thick, fill=red!12, rounded corners=2pt, minimum width=1.0cm, minimum height=1.3cm, inner sep=2pt, align=center, font=\scriptsize] (rx) at (6.3,-0.1) {\textcolor{red!70!black}{Coil}\\\textcolor{red!70!black}{$n$}};
\draw[->, red!45, thick] (rx.west) to[bend right=8] (3.5,0.5);
\draw[->, red!45, thick] (rx.west) to[bend left=8] (3.5,-0.7);
% Equation
...
\draw[cyan!45, thick] (3.2,0.2) ellipse (1.55 and 2.15);
\node[font=\scriptsize, cyan!45!black] at (3.2,0.2) {Lung};
% Heart ED (filled) then ES (covers center -> orange ring = V_Delta)
\fill[orange!35] (0,-0.1) ellipse (1.9 and 2.0);
\fill[red!10] (0,-0.1) ellipse (1.3 and 1.4);
\draw[red!70!black, very thick] (0,-0.1) ellipse (1.9 and 2.0);
\draw[red!55, very thick, dashed] (0,-0.1) ellipse (1.3 and 1.4);
...
\draw[red!70!black, thin] (edl.south) to[bend right=12] (1.35,1.45);
\node[font=\small, red!55!black] (esl) at (-2.6,4.15) {ES ($\varphi_2$)};
\draw[red!55, thin] (esl.south) to[bend left=12] (-0.92,1.02);
% V_Delta label
\node[font=\small\bfseries, orange!78!black] (vd) at (5.4,-2.7) {$V_{\Delta}$};
\draw[->, thick, orange!78!black] (vd.west) to[bend right=10] (1.55,-1.15);
% Anterior / Posterior
